...
ui <- navbarPage(
  ...
  tabPanel(
    title = span("Viral-R", title = "Are you ready to enoy gene regulation by viruses?"), icon = tags$img(src = "virus.webp", height = 16, width = 16),
    fluidPage(
      sidebarLayout(
        ...
        mainPanel(tabsetPanel(tabPanel(title = span("Viral-R", title = "The homepage for Viral-R"), 
                                       icon = icon("house"),
            ...
            tabPanel(title = span("Information", title = ""), 
                     ...
                     p(HTML(
                       "<ul style='font-size: 24px;'>
                                         ...
                                         <li><em>Heatmap</em> allows users to select specific signaling pathways to observed the expression 
